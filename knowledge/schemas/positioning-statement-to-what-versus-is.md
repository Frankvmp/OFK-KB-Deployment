...
1. **To:** the target segment or mass market, summarised from the target
   portrait.
2. **What:** the company, brand, product, or alternative way of thinking being
   positioned.
3. **Versus:** the alternative the customer is considering, including the
   status quo or non-choice where relevant.
4. **Is:** the intended association, which may be a category entry point,
   feature, benefit, or emotional association.
...
- Do not omit the alternative in the “versus” slot.
- Do not substitute a slogan for the underlying position.
