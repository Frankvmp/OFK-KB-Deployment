...
- [Distinctiveness is recognition, not competitive superiority](../principles/distinctiveness-is-recognition-not-competitive-superiority.md) (Principle) — states the job the selected codes perform.
- [Brand codes should be few, stable, and consistently applied](../principles/brand-codes-should-be-few-stable-and-consistently-applied.md) (Principle) — governs the palette's size and use.
- [Brand-specific code evidence can override category averages](../principles/brand-specific-code-evidence-can-override-category-averages.md) (Principle) — governs exceptions during code selection.

## Shape

1. **Logo:** the prime code and first item in the palette.
2. **Additional codes:** a small set of other sensory or visual identifiers,
...
- Do not treat every brand asset as part of the selected palette.
- Do not assume the same codes transfer between brands.
