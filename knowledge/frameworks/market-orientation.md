...
benchmarking, and later tracking of market orientation.
...
1. **Get a product idea into the market with lead users immediately.** If we have a great product idea, instantly get into the market and test it out among some lead users.
...
1. **Generate market and competitor intelligence.** ...
...
2. **Irrigate (disseminate) that intelligence through the organization.** Once they gathered that information, though, there had to be at the heart of any market oriented company an ability to irrigate that information
...
3. **Respond -- not necessarily by complying.** there had to be a responsiveness ultimately to all of that intelligence... response doesn't always mean doing what the customer wants... Responsiveness can be saying no or doing nothing.
