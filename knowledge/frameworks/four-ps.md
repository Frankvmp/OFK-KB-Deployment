...
- [Marketing is broader than advertising and sales](../principles/marketing-is-broader-than-advertising-and-sales.md) (Principle) — frames the four Ps as evidence that marketing is broader than promotion alone.
- [Strategy should be disciplined while tactics remain agile](../principles/strategy-should-be-disciplined-while-tactics-remain-agile.md) (Principle) — governs adaptation within a stable strategic direction.
- [Marketing influence does not require control of every P](../principles/marketing-influence-does-not-require-control-of-every-p.md) (Principle) — requires meaningful input across all four tactical areas.
- [Product success requires quality and market preparation](../principles/product-success-requires-quality-and-market-preparation.md) (Principle) — keeps product quality and the surrounding marketing work connected.
- [Existing products should be continuously improved](../principles/existing-products-should-be-continuously-improved.md) (Principle) — extends product responsibility beyond new-product launches.
- [Customers buy solutions to jobs, not products as defined internally](../principles/customers-buy-solutions-to-jobs-not-products-as-defined-internally.md) (Principle) — grounds product improvement and communication in the customer's underlying job.
- [Co-branding works through complementary association transfer](../principles/co-branding-works-through-complementary-association-transfer.md) (Principle) — governs partner fit within product diversification.
- [Product expansion must be balanced with rationalisation](../principles/product-expansion-must-be-balanced-with-rationalisation.md) (Principle) — governs the balance between portfolio creation and removal.
- [Marketing must create value for both customers and the organisation](../principles/marketing-must-create-value-for-both-customers-and-the-organisation.md) (Principle) — keeps customer and organisational value aligned across the tactical mix.
- [Pricing is the revenue-producing element of the marketing mix](../principles/pricing-is-the-revenue-producing-element-of-the-marketing-mix.md) (Principle) — identifies pricing's distinctive economic role among the four Ps.
- [Pricing power combines value perception with the ability to hold price](../principles/pricing-power-combines-value-perception-with-the-ability-to-hold-price.md) (Principle) — connects supported customer perceptions to price capture.
- [Price should follow customer perceived value, not cost-plus arithmetic](../principles/price-should-follow-customer-perceived-value-not-cost-plus-arithmetic.md) (Principle) — governs the basis for setting price.
- [Price presentation shapes perceived value and demand](../principles/price-presentation-shapes-perceived-value-and-demand.md) (Principle) — makes price communication part of tactical pricing.
- [Price increases should be communicated candidly and with value context](../principles/price-increases-should-be-communicated-candidly-and-with-value-context.md) (Principle) — governs communication when the pricing P changes.
- [Repeated discounting can become a self-reinforcing strategic trap](../principles/repeated-discounting-can-become-a-self-reinforcing-strategic-trap.md) (Principle) — prompts diagnosis across the mix before repeating promotions.
- [Evidence-backed value supports holding the price line](../principles/evidence-backed-value-supports-holding-the-price-line.md) (Principle) — tests whether the wider mix supports maintaining price.
- [Direct-channel control does not guarantee scale or profitability](../principles/direct-channel-control-does-not-guarantee-scale-or-profitability.md) (Principle) — keeps direct distribution choices tied to wider commercial and tactical outcomes.
- [Omnichannel quality depends on integration, not channel count](../principles/omnichannel-quality-depends-on-integration-not-channel-count.md) (Principle) — governs distribution quality across connected channels rather than treating channel count as the goal.

## Definition

The framework is derived from the marketing mix commonly expressed as product,
price, promotion, and place. The terms are interpreted operationally as
follows:

- **Product:** the offering delivered to the market.
- **Pricing:** the process of researching, setting, framing, and changing the
  amount and terms exchanged for the offering.
- **Marketing communications:** the broader communications activity used to
  communicate the offering and its value, including advertising and
  promotions.
- **Distribution:** the channels and arrangements that make the offering
...
experiences and touchpoints through which the offering is delivered. The
specific decision method depends on the product problem being addressed.

### Pricing

Pricing is more than selecting a monetary price. It includes the research and
...
market position, and the commercial result, so pricing cannot be treated as an
isolated financial afterthought.

### Marketing communications

Marketing communications is broader than advertising. It includes the ways the
...
Distribution concerns the channels and arrangements that make the offering
...
**Step type:** Constraint check — target, position, and objective must already be settled; the Four Ps cannot substitute for them.
...
### 2. Translate the strategy into requirements

**Step type:** Evidence-and-judgement — deriving concrete tactical requirements from strategic choices.

For each P, state what the target, position, and objective require. The result
is a set of tactical requirements, not yet a list of preferred tactics.

### 3. Review each P

**Step type:** Decision (criteria-guided) — testing each available decision against the tactical requirements.

Examine product, pricing, marketing communications, and distribution in turn.
Identify the decisions available in each area and test each decision against
the tactical requirements.

### 4. Check cross-P alignment

**Step type:** Constraint check — all four areas must reinforce the same target, position, and objective.
...
**Step type:** Constraint check — marketing must have real input into every P, not just communications.

Marketing responsibility does not require direct control of every P. Control
...
**Step type:** Constraint check — tactical agility is allowed; strategic drift during the planning period is not.
...
No direct supporting Metric is attached to the Four Ps framework. The cited
new-product failure estimates belong to the New Product Development framework,
where they describe the survival or failure of new products. They are not a
measure of the Four Ps as a whole and should not be used as one.
...
**Inputs and preconditions:** Explicit trigger: the 80/20 rule ('20% of their products deliver 80% of their profits... why don't I just keep the 20%... and get rid of the rest').
