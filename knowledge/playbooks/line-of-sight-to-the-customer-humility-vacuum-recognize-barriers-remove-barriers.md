...
This playbook defines an ordered process for line of sight to the customer (humility -> vacuum -> recognize barriers -> remove barriers). The sequence and decision points are retained from the registered evidence.

## Invokes

- [Marketers are not the consumer](../principles/marketers-are-not-the-consumer.md) (Principle) — supplies the humility and anti-projection reasoning that starts this Playbook.
- [Market orientation must precede market research](../principles/market-orientation-must-precede-market-research.md) (Principle) — connects the created knowledge gap to evidence gathering.
- [Understand customers in their real context](../principles/understand-customers-in-their-real-context.md) (Principle) — carries customer humility into direct contextual observation.

## Inputs and preconditions

No explicit precondition stated -- this is the individual-level starting discipline of the whole course.

## Ordered steps

### 1. Accept you are not the consumer (humility)
...
### 3. Recognize the barriers to market orientation
...
### 4. Remove the barriers to gain line of sight to the customer
...
"we have to begin by accepting we know nothing with a vacuum... we will gather data and the data will lead to segments and the segments will lead to targeting and the marketing journey will begin." (00:11:54 relative / 01:11:54 abs) -- hands off to Module 2 (research), Module 3 (segmentation), and Module 4 (targeting).

## Explicit consumers

- Module 2: Market Research: vacuum is explicitly filled with data gathered per Module 2's methods
- Module 3/4: output explicitly said to lead to segments then targeting
...
[^origin]: ../../transcripts/market-orientation-m1-video.md#00:21:01
[^step-2]: ../../transcripts/market-orientation-m1-video.md#00:23:02
[^step-3]: ../../transcripts/market-orientation-m1-video.md#01:10:46
[^step-4]: ../../transcripts/market-orientation-m1-video.md#00:32:37
