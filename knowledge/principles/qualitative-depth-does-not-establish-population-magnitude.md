...
This Principle defines what qualitative evidence cannot establish. [Discover options qualitatively before measuring them](discover-options-qualitatively-before-measuring-them.md) explains why qualitative work should nevertheless come before quantitative measurement.

The [Market Research Method Sequence](../playbooks/market-research-method-sequence-secondary-qualitative-quantitative-mid-stage-focus-groups.md) connects these roles without treating the methods as interchangeable.

## Invokes

- [Market Research Method Sequence](../playbooks/market-research-method-sequence-secondary-qualitative-quantitative-mid-stage-focus-groups.md) (Playbook) — uses qualitative work for discovery and quantitative work for measurement.
- [Ethnographic Research Procedure](../frameworks/research-informs-understanding-not-strategy.md#ethnographic-research-procedure) (embedded Playbook) — provides the source-supported route for contextual depth.
