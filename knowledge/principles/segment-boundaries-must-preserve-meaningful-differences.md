...
Draw cut-off lines where the distinction has a real implication for the market or organisation, not at an arbitrary numerical point.

Collapse groups to make the map manageable only while each resulting segment remains coherent. If one segment requires conflicting customer portraits or different positioning offers, it has been collapsed too far.
