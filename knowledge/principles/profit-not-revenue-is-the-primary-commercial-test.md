...
Profit focus does not mean revenue is irrelevant. It means revenue must be interpreted together with costs and margin rather than celebrated in isolation.

## Invokes

- [Value and profitability](../frameworks/value-and-profitability.md) (Framework) — distinguishes value, revenue, margin, and profitability in pricing decisions.
- [Seven-Step Route Out of Discounting](../playbooks/seven-step-route-out-of-discounting.md) (Playbook) — begins and ends with profit focus when recovering from promotional dependence.
