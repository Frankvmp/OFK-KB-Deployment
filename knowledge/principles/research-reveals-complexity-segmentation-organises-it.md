...
The sequence prevents invented segments. It also prevents averages from erasing the variation that research was meant to expose.

## Related distinctions

Research gathers and tests evidence; segmentation structures the resulting variation. Segmentation is not a substitute for research, and a research average is not itself a segment.

## Invokes

- [Market Research Method Sequence](../playbooks/market-research-method-sequence-secondary-qualitative-quantitative-mid-stage-focus-groups.md) (Playbook) — gathers the evidence from which patterns can be identified.
- [Segmentation Process](../playbooks/segmentation-process-top-level-5-step-sequence.md) (Playbook) — turns market evidence into a populated and checked market map.
